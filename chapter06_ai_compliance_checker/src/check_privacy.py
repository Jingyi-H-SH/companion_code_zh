"""Review privacy practices with a structured LLM rubric."""
...
def run_privacy_check(system_profile: dict, checklist_items: list[dict]) -> dict:
    prompt = (
        ...
        "Review the privacy posture of the system. Score each item from 0 up to its weight."
    )
    result = json_completion(
        "You review privacy safeguards for health AI systems. Return concise evidence-based JSON.",
        prompt,
        "privacy_review",
        SCHEMA,
    )
